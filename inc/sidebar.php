 ...
 $queryMainMenu = mysqli_query($config, "SELECT DISTINCT menus. * FROM menus JOIN menu_roles ON menus.id = menu_roles.id_menu JOIN roles ON roles.id = menu_roles.id_role WHERE menu_roles.id_role = '$id_roles' 
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <?php foreach($rowMainMenu as $mainMenu): ?>
        ...
        <?php
          $id_menu = $mainMenu['id'];
          $querySubMenu = mysqli_query($config, "SELECT DISTINCT menus. * FROM menus JOIN menu_roles ON menus.id = menu_roles.id_menu JOIN roles ON roles.id = menu_roles.id_role WHERE menu_roles.id_role = '$id_roles' AND parent_id = '$id_menu' ORDER BY urutan ASC");
        ?>
